...
export default function Footer() {
  return (
    <footer sx={styles.footer}>
      ...
      &copy; 2024 Maestri.Edu - Todos os direitos reservados | Design & Developed by Matheus Caprioli |
        <Link path="https://www.maestri.edu.br/" target="_blank">
        V7M Empresarial LTDA - CNPJ 48.811.016/0001-00
        </Link>
      </Text>
    </footer>
  );
